...
const arrowIcon = $(".arrow_iconnnn i");
$(".bigimg").on({
  mouseenter: () => arrowIcon.fadeIn(),
  mouseleave: () => arrowIcon.fadeOut(),
});
...
$(".like").click(function () {
  if ($(this).hasClass("active")) {
    ...
    $(this).html(
      '<i class="fa fa-heart" aria-hidden="true"><span>&nbsp;Like 1</span></i>'
    );
    $(".like i").css({ color: "#979797" });
  } else {
    $(this).addClass("active");
    $(this).html(
      '<i class="fa fa-heart" aria-hidden="true"><span>&nbsp;Like 2</span></i>'
    );
